...
/**
* Weke'ula's object class.
* This is the fourth and final phase of Weke'ula life
...
* @since 2/24/22
*/
public class WekeUla extends Oama {
   ...
   */
   public WekeUla() {
      super("Weke'ula", ENGLISH_NAME, SCIENTIFIC_NAME, WEKE_ULA_MAX_LENGTH, 
      WEKE_ULA_MIN_LENGTH, WEKE_ULA_MIN_LENGTH, (WEKE_ULA_MIN_LENGTH * 2), DIETITEMS,  
   ...
   * @throws FishSizeException if length is less than minLength
   */
   public WekeUla(double length) {
      super("Weke'ula", ENGLISH_NAME, SCIENTIFIC_NAME, WEKE_ULA_MAX_LENGTH, 
      WEKE_ULA_MIN_LENGTH, length, (length * 2), DIETITEMS,  "white with yellow stripe", 
      "yellow", "male or female"); 
      this.initSex();
      
   }
   
   //Weke'ula do not change to another type, so we overwrite the grow method from the base class.
   /**
   ...
   */
   ...
   /** 
   * changes this Weke'ula's s sex.
   * Weke'ula cannot change sex within their size group
   */
   public void changeSex() {
      throw new UnsupportedOperationException("Weke'ula cannot change sex.");
   }
   ...
   */
   ...
   //============== required by ColorChangable interface ===============================
